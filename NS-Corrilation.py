...
wb_op = load_workbook('Optimized - NS-050.xlsx', data_only = True)
...
wb_hand = load_workbook('2017.08.29 - NS EG - 50 - Corrected.xlsx', data_only = True)
    ...
    while m < 2.5:
        ...
        for i in range (0,36):
            ...
            if sum_dsqrd < best_dist:
                ...
                m += 0.0001
    poly = numpy.polyfit(average_hand, average_op,1)
    print(sheet + " : " + str (poly[0]))
